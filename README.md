...
- Additional fast-close buy: if **time to close < 60s** and **either YES or NO is in the 0.90–0.97 band**, it buys only the side in-band, even if the combined price is >= `COMBINED_MAX_PRICE`
